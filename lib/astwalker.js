...
module.exports = code => {
  ...
  walk(node => {
    ...
    // only needs rewrite when its an import basicly...
    ...
    if (node.type === 'ExportNamedDeclaration') {
      ...
      if (node.specifiers.length) {
        ...
        const exports = {
          ...
          sEnd: node.declaration.declarations[0].init.start,
          identifier: node.declaration.declarations[0].id.name,
          type: 'const'
        }
        replaceExports.push(exports)
      }
